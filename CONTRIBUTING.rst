.. _issues: https://github.com/leaprovenzano/hypothesis-torch/issues
...
* Any details about your local setup that might be helpful in troubleshooting. This must include your version of python and hypothesis_torch
...
1. Fork the hypothesis_torch repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/hypothesis-torch.git

3. Install your local copy into a virtualenv::

    $ python3 -m hypothesis-torch/env
    $ cd hypothesis-torch
